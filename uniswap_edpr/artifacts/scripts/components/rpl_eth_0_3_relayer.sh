#!/bin/bash
# init
dfx canister  call rpl_eth_0_3_relayer init_in '(variant { "LocalDevelopment" }, record {
...
# setup
dfx canister  call rpl_eth_0_3_relayer setup "(
...
# set_task
dfx canister  call rpl_eth_0_3_relayer set_task '(7200, 10)'
