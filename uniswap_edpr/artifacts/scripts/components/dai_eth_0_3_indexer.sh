...
dfx canister --network ic call dai_eth_0_3_indexer setup "(
    ...
    vec { \"qm6az-jyaaa-aaaag-qc5rq-cai\"; \"qzzru-iqaaa-aaaag-qc5sa-cai\"; \"q6yxa-fiaaa-aaaag-qc5sq-cai\"; \"ql7gn-eaaaa-aaaag-qc5ra-cai\" },
)"
# set_task
dfx canister --network ic call dai_eth_0_3_indexer set_task '(43200, 5)'
