#!/bin/bash
# init
dfx canister --network ic call rpl_eth_0_3_pool_fees init_in '(variant { "Production" }, record {
...
# set_task
dfx canister --network ic call rpl_eth_0_3_pool_fees set_task '(43200, 10)'
