#!/bin/bash
# init
dfx canister  call shib_eth_1_tcumul_28x6hr init_in '(variant { "LocalDevelopment" }, record {
...
# setup
dfx canister  call shib_eth_1_tcumul_28x6hr setup "(
...
# set_task
dfx canister  call shib_eth_1_tcumul_28x6hr set_task '(144, 0)'
