#!/bin/bash
# init
dfx canister  call white_eth_0_01_indexer init_in '(variant { "LocalDevelopment" }, record {
...
# setup
dfx canister  call white_eth_0_01_indexer setup "(
...
# set_task
dfx canister  call white_eth_0_01_indexer set_task '(7200, 5)'
