#!/bin/bash
# init
dfx canister --network ic call shib_eth_1_pool_fees init_in '(variant { "Production" }, record {
...
# set_task
dfx canister --network ic call shib_eth_1_pool_fees set_task '(43200, 10)'
