#!/bin/bash
# init
dfx canister --network ic call white_eth_0_01_v3pool init_in '(variant { "Production" }, record {
...
# set_task
dfx canister --network ic call white_eth_0_01_v3pool set_task '(7200, 10)'
