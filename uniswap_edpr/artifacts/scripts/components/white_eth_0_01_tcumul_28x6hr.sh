#!/bin/bash
# init
dfx canister  call white_eth_0_01_tcumul_28x6hr init_in '(variant { "LocalDevelopment" }, record {
...
# setup
dfx canister  call white_eth_0_01_tcumul_28x6hr setup "(
...
# set_task
dfx canister  call white_eth_0_01_tcumul_28x6hr set_task '(7200, 0)'
