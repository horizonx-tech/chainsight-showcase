#!/bin/bash
# init
dfx canister --network ic call wsteth_eth_0_01_pool_fees init_in '(variant { "Production" }, record {
...
# set_task
dfx canister --network ic call wsteth_eth_0_01_pool_fees set_task '(14400, 10)'
